...
function menuObserver(e){e=e[0];(e.isIntersecting?menuActive:menuDeactive)(e.target.dataset.menuSection)}var activeClass="whitepaper-single__sidebar-list-item--active";function menuActive(e){document.querySelectorAll(".whitepaper-single__sidebar-list a[href='#"+e+"']").forEach(function(e){$(".whitepaper-single__sidebar-list li").removeClass(activeClass),$(e).parents("li").addClass(activeClass)})}function menuDeactive(e){document.querySelectorAll(".whitepaper-single__sidebar-list a[href='#"+e+"']").forEach(function(e){e.classList.remove("active")})}function observerWhitePaperSideBar(){var i=new IntersectionObserver(menuObserver,{});document.querySelectorAll(".menu-observe").forEach(function(e){i.observe(e)}),$(".whitepaper-single__sidebar-list-item a").click(function(){var e=$(this).attr("href");window.setTimeout(function(){menuActive(e.slice(1))},300)})}jQuery(document).ready(function(i){var t;(i("body").hasClass("single-whitepaper")||i("body").hasClass("page-template-page-whitepaper-with-toc"))&&(t="ul.whitepaper-single__sidebar-list li.whitepaper-single__sidebar-list-item",i("img").on("load",function(){Waypoint.refreshAll()}),i(".whitepaper-single__sidebar-list-item a").click(function(){var e=i(this).data("toc-index");i(this).toggleClass("is-active"),i(".whitepaper-single__sidebar-list").toggleClass("is-active"),i(".whitepaper-single__sidebar-divider").toggleClass("is-active"),window.setTimeout(function(){i(t).removeClass(activeClass),i(t+'[data-toc-index="'+e+'"]').addClass(activeClass)},250)}),i(".js-trigger-whitepaper-toc").click(function(e){e.preventDefault(),i(this).toggleClass("is-active"),i(".whitepaper-single__sidebar-list, .whitepaper-single__sidebar-divider").toggleClass("is-active")}),observerWhitePaperSideBar())});
var $carousel,flkty,$videoCarouselNav=$(".video-carousel__nav");jQuery(document).ready(function(t){function i(){var e,i;t(".carousel-item").removeClass("visible"),t(".carousel-item").attr("aria-hidden",!0),t(".carousel-item.is-selected").addClass("visible"),t(".carousel-item.is-selected").attr("aria-hidden",!1),992<t(window).width()?(e=t(".carousel-item.is-selected").next(),t(e).length<1&&(e=t(".carousel-item").first()),t(e).addClass("visible"),t(e).attr("aria-hidden",!1),i=t(e).next(),t(i).length<1&&(i=t(".carousel-item").first()),t(i).addClass("visible"),t(i).attr("aria-hidden",!1)):t(window).width()<=992&&768<t(window).width()&&(e=t(".carousel-item.is-selected").next(),t(e).length<1&&(e=t(".carousel-item").first()),t(e).addClass("visible"),t(e).attr("aria-hidden",!1))}function e(){i(),window.console.log(t(window).width()),t(window).width()<=768&&(flkty.options.draggable=!0,flkty.updateDraggable(),$videoCarouselNav.show()),t(window).width()<=992&&(flkty.cells.length<=2?$videoCarouselNav.hide():($videoCarouselNav.show(),flkty.options.draggable=!0,flkty.updateDraggable())),992<t(window).width()&&flkty.cells.length<=3&&(flkty.options.draggable=!1,flkty.updateDraggable(),$videoCarouselNav.hide()),flkty.resize()}var l,a;0<t(".carousel-section").length&&($carousel=t(".video-carousel").flickity({cellAlign:"left",wrapAround:!0,prevNextButtons:!1,pageDots:!1}),flkty=$carousel.data("flickity"),l=t(".video-carousel__dots"),a=l.find(".dot"),e(),t(window).resize(e),$carousel.on("select.flickity",function(){a.filter(".is-selected").removeClass("is-selected"),a.eq(flkty.selectedIndex).addClass("is-selected")}),$carousel.on("dragStart.flickity",function(){t(".carousel-item").addClass("visible")}),$carousel.on("dragEnd.flickity",function(){i()}),l.on("click",".dot",function(){var e=t(this).index();$carousel.flickity("select",e),i()}),t(".button--previous").on("click",function(){$carousel.flickity("previous"),i()}),t(".button--next").on("click",function(){$carousel.flickity("next"),i()}))});
...
$("[data-fancybox]").fancybox({onInit:function(o){var r=(r=o.group[o.currIndex].opts.$orig.data("color"))||"#fff";o.$refs.bg.css({"background-color":r,opacity:1})},beforeShow:function(o,r){r=r.opts.$orig.data("color")||"#fff";o.$refs.bg.css("background-color",r)}});
